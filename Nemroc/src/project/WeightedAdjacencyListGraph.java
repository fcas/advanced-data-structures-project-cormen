 ...
 * 
 * The representation and use are similar to the superclass
 * {@link AdjacencyListGraph}. The primary difference is that the inner class
 * {@link AdjacencyListGraph.Edge} is subclassed here as
 * {@link WeightedAdjacencyListGraph.WeightedEdge}, and objects of this subclass
 * include a weight. The inner {@link WeightedAdjacencyListGraph.EdgeIterator}
 * class overrides the {@link AdjacencyListGraph.EdgeIterator} class and
 * implements the {@link WeightedEdgeIterator} interface, so that edge weights
 * can be get and set during iterations through edges.
 */
...
public class WeightedAdjacencyListGraph extends AdjacencyListGraph {
	 ...
	 * 
	 * @param cardV
	 *            How many vertices this graph will have.
	 * @param directed
	 *            Flag indicating whether this graph is directed.
	 */
	...
	/**
	 * Adds a weighted edge to this graph. The edge is specified by a pair of
	...
	/**
	 * Inner class for weighted edges in adjacency lists. Adjacency lists are
	 * singly linked.
	 */
	...
	/**
	 * Returns an iterator that iterates through the weighted edges incident on
	 * a given vertex. Each incident edge is indicated by the corresponding
	 * adjacent vertex.
	 * 
	 * @param u
	 *            The vertex whose incident edges are returned by the iterator.
	 */
	 ...
	 * 
	 * @param u
	 *            The index of the vertex whose incident edges are returned by
	 *            the iterator.
	 */
	...
	/**
	 * Returns an iterator, of type <code>WeightedEdgeIterator</code> (so that
	 * the caller does not need to cast the result), that iterates through the
	 * weighted edges incident on a given vertex. Each incident edge is
	 * indicated by the corresponding adjacent vertex.
	 * 
	 * @param u
	 *            The vertex whose incident edges are returned by the iterator.
	 */
	...
	/**
	 * Inner class that overrides <code>AdjacencyListGraph.EdgeIterator</code>
	 * to implement <code>WeightedEdgeIterator</code>.
	 */
	public class EdgeIterator extends AdjacencyListGraph.EdgeIterator implements
			WeightedEdgeIterator {
		/**
		 * Starts an iteration through the weighted edges incident on a given
		 * vertex.
		 * 
		 * @param v
		...
		/**
		 * Returns the weight of the edge returned by the most recent call to
		 * <code>next</code>.
		 */
		public double getWeight() {
	...
	/**
	 * Creates and returns an empty <code>WeightedAdjacencyListGraph</code> with
	 * no edges, given the number of vertices and a boolean indicating whether
	 * the graph is directed.
	 * 
	 * @param cardV
	 *            How many vertices in the new graph.
	 * @param directed
	 *            Flag indicating whether this graph is directed.
	 */
	...
	/**
	 * Returns the <code>String</code> representation of this weighted graph.
	 */
