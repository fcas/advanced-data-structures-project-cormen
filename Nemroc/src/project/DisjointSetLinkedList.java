...
/**
 * Linked-list implementation of disjoint-set union, using the weighted-union
 * heuristic, as given on pages 502-503 of <i>Introduction to Algorithms</i>,
 * Second edition.
 * 
 * <p>
 * 
 * The representative pointer is different here from in the book. In order to be
 * able to get to the information for a set, the representative here references
 * the set, rather than the first node in the set's list.
 */
...
public class DisjointSetLinkedList implements DisjointSetUnion {
	...
	private static class DisjointSet {
		 ...
		 * 
		 * @param x
		 *            The node in this singleton set.
		 */
		...
		/**
		 * Returns the <code>String</code> representation of this set, with each
		 * element appearing on a separate line.
		 */
		public String toString() {
			String result = "";
	 ...
	 * @return A handle that serves to identify the set in future operations.
	 */
	...
	/**
	 * Unites two sets, identified by handles to objects in the sets. The
	 * original sets are destroyed.
	 * 
	 * @param x
	 *            Handle to an object in one set.
	 * @param y
	 *            Handle to an object in the other set.
	 * @throws ClassCastException
	 *             if either <code>x</code> or <code>y</code> does not reference
	 *             a <code>DisjointSet</code> object.
	 */
	 ...
	 * 
	 * @param first
	 *            The set to which the other will be appended.
	 * @param second
	 *            The set that will be appended to the other.
	 * @throws DisjointSetUnionException
	 ...
	 * @throws ClassCastException
	 *             if <code>x</code> is not a reference to a <code>Node</code>
	 *             object.
	 */
	...
	/**
	 * Returns the <code>String</code> representation of the set containing a
	 * given object.
	 * 
	 * @param x
	 *            The object whose set's <code>String</code> representation is
	 *            returned.
	 */
	...
	/**
	 * Inner class for an exception that occurs if either set to be united is
	 * empty.
	 */
